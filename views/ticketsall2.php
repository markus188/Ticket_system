...
<html lang="en">
    <head>	
        ...
        <meta charset="UTF-8">
        <meta http-equiv="refresh" content="600;url=https://intranet.pardubice.cmnet.cz/ticketsall2">
...
<?php
                     ...
                     ?><a href="<?php echo site_url('Ticket/auto_submit/'. $zas->nasid);?>">
                     <?php
                     echo '<span title= "' . $zas->nxt_stav . '" class=" ' . $color2 .  ' mr-10 font-12 ' . $zas->nxt_icon . ' "></span></a></div>';
                     
                     
                      } else { 
                     echo '<div class="col-sm-1 ptb-5 bg-pozadi ' . $color4 .  ' "><span title= "' . $zas->nxt_stav . '" class=" ' . $color2 .  ' mr-10 font-12 ' . $zas->nxt_icon . ' "></span></div>';
                    } 
...
<?php
                    ...
                    echo '<div class="col-sm-1 ptb-5  ' . $color4 .  ' ">' . $zas->prijmeni . '</div>';
                     ...
                     echo '<div class="col-sm-1 ptb-5 ' . $color4 .  ' "><span title= "' . $zas->nxt_stav . '" class=" ' . $color2 .  ' mr-10 font-12 ' . $zas->nxt_icon . ' "></span></div>';
                    } 
