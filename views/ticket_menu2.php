...
<?php 
                ...
                $js = 'class="p-10  brder-grey-full2 card-view-full w-100 br-3 " title="Oddělení (vybrat ze seznamu)"' . '" onChange="this.form.submit()"';
...
<?php 
                ...
                $js = 'class="p-10  brder-grey-full2 card-view-full w-100 br-3 " title="Řešitel (vybrat ze seznamu)"' . '" onChange="this.form.submit()"';
...
<?php 
            ...
            echo form_dropdown('oddeleni_zadal', $oddeleni_zadal, $filtr['oddeleni_zadal'], $js);   
               ...
               <input class=" card-view-bottom brder-grey-full2" type="text" name="oddeleni_zadal" value="<?php   echo $odd_name ; ?>" title="Oddělení zadal" placeholder="Oddělení zadal" disabled>                            
...
<?php 
                ...
                $js = 'class="p-10 brder-grey-full2 card-view-full w-100 br-3 " title="Zadavatel (vybrat ze seznamu)"' . '" onChange="this.form.submit()"';
            ...
            echo form_dropdown('oc_zadal', $oc_zadal, $filtr['oc_zadal'], $js);  
               ...
               <input class=" card-view-bottom brder-grey-full2" type="text" name="oc_zadal" value="<?php   echo $prijmeni ; ?>" title="Zadavatel" placeholder="Zadavatel" disabled>                            
...
<?php 
                ...
                $js = 'class="p-10  brder-grey-full2 card-view-full w-100 br-3 " title="Stav realizace(vybrat ze seznamu)"' . '" onChange="this.form.submit()"';
...
<?php 
                ...
                $js = 'class="p-10  brder-grey-full2 card-view-full w-100 br-3 " title="Řazení(vybrat ze seznamu)"' . '" onChange="this.form.submit()"';
            ...
            echo form_dropdown('sort', $sort, $filtr['sort'], $js);  
                    ...
                    <div class="col-md-12 col-lg-6">
                        ...
                        <input class=" card-view-full brder-grey-full2" type="date" name="zadani_od" value="<?php   echo $filtr['zadani_od'] ; ?>" onChange="this.form.submit()"  max="<?php echo $filtr['zadani_do'];?>" >                                                                        
                    </div>                                                  
                    <div class="col-md-12 col-lg-6">
                        <div class=" ptb-5  plr-15 <?php   echo $color1 ; ?>"><strong>Zadání do</strong>
                            <span class="float-right pr-5 ion-android-create">
                        </div>                                                  
                        <input class="card-view-full brder-grey-full2" type="date" name="zadani_do" value="<?php   echo $filtr['zadani_do'] ; ?>" onChange="this.form.submit()"  min="<?php echo $filtr['zadani_od'];?>">                                                                        
                    </div>                                                
                     <div class="col-md-12 col-lg-6">
                        <div class="ptb-5  plr-15 <?php   echo $color2 ; ?>"><strong> Termín od</strong>
                            <span class="float-right pr-5 ion-android-create">
                        </div>                                                   
                        <input class=" card-view-full brder-grey-full2" type="date" name="terminok_od" value="<?php   echo $filtr['terminok_od'] ; ?>" onChange="this.form.submit()" max="<?php echo $filtr['terminok_do'];?>" >                                                                        
                    </div>                                                  
                    <div class="col-md-12 col-lg-6">
                        <div class="ptb-5  plr-15 <?php   echo $color3 ; ?>"><strong> Termín do</strong>
                            <span class="float-right pr-5 ion-android-create">
                        </div>                                                    
                        <input class=" card-view-full brder-grey-full2" type="date" name="terminok_do" value="<?php   echo $filtr['terminok_do'] ; ?>" onChange="this.form.submit()" min="<?php echo $filtr['terminok_od'];?>" >                                                                        
                    </div> 
                     ...
                     <div class="col-md-12 col-lg-6">
                      ...
                      <div class="card-view-full brder-grey-full2 nwsltr-primary-1"> <input type="button" onclick="window.location.href='https://intranet.pardubice.cmnet.cz/Ticket/filter_resetall2';" value="Vymazat filtr" />   </div>                                          
                    </div>        
                    ...
                    <div class="col-md-12 col-lg-6">
                      ...
                      <div class="card-view-full brder-grey-full2 nwsltr-primary-1">   <input class=" nwsltr-primary-1" type="button" onclick="window.location.href='https://intranet.pardubice.cmnet.cz/Ticket/filter_save2';" value="Uložit jako výchozí" />  </div>                                               
                    </div> 
                    
                    <?php      if ( $oddeleni == 2 and $typ == 1) {     ?>
